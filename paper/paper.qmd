...
The data are available through the Environmental Data Initiative. You can find them here: https://portal.edirepository.org/nis/mapbrowse?packageid=knb-lter-luq.20.4923064.
...
# Saving data frame for intermediate outputs
saveRDS(comb_table, "comb_table.rds")
```
...
# Saving potassium data frame for intermediate outputs
...
# Saving nitrate_N data frame for intermediate outputs
saveRDS(df_no, "df_no.rds")
```
...
# Saving magnesium data frame for intermediate outputs
...
# Saving calcium data frame for intermediate outputs
...
# Saving ammonia-N data frame for intermediate outputs
saveRDS(df_nh4_n, "df_nh4_n.rds")
