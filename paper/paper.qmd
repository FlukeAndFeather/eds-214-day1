...
This project is part of the course Environmental Data Science Analytical Workflows and Scientific Reproducibility, that aims to recreate **Figure 3.** from Schaefer et al.[(2000)](https://doi.org/10.1017/s0266467400001358) study. This time-series plot shows a 9-week moving average of streamwater concentrations before and after the 1989 Hurricane Hugo disturbance, based on long-term stream water quality observations in the Luquillo Mountains, Puerto Rico.

**Figure 3**

![](images/clipboard-318770943.png){width="430"}
...
![](images/Data-01.png){width="Infinity" fig-align="center"}
...
plot_k <- read(here("output", "RDS", "plot_k.rds"))
